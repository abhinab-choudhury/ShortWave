...
export function DashboardLayout() {
  const links = [
    ...
    },
    {
      label: "Analytics",
      href: "analytics",
      icon: <IconChartCovariate className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />,
    },
    {
      label: "Settings",
      href: "settings",
          ...
          <div className="flex flex-col flex-1">
            ...
            <div className="mt-8 flex flex-col gap-2 h-fit">
              ...
              >
                ...
                <div className="text-neutral-700 dark:text-slate-200 text-sm font-medium group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0">
                  Logout
                </div>
              </button>
            </div>
          ...
          <div className="mt-auto w-full">
            ...
            >
              ...
              <motion.span
                ...
                className="w-full truncate text-neutral-700 dark:text-slate-200 text-sm font-medium group-hover/sidebar:translate-x-1 transition-all duration-150 whitespace-pre inline-block !p-0 !m-0"
              >
      ...
      <Link to="/home" className="font-normal flex space-x-2 items-center text-base text-gray-950 py-1 relative z-20">
        <div className="flex gap-3">
          ...
          <motion.span
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="font-semibold tracking-tight text-teal-600 text-xl md:text-2xl dark:text-white whitespace-pre font-sans"
          >
            ShortWave
          </motion.span>
        </div>
