...
const DashboardPage = () => {
  ...
  return (
    <div className="flex flex-1 min-w-0">
      <div className="font-sans p-4 sm:p-6 bg-slate-50/50 dark:bg-slate-950 flex flex-col gap-3 flex-1 w-full max-h-screen overflow-y-auto overflow-x-hidden scrollbar-slim">
        <div className="mb-4">
