            ...
            <div className="flex-1 space-y-6">
              <div>
                ...
                <input
                  ...
                  value={user?.name || ""}
                  disabled
                  className="w-full bg-slate-50 dark:bg-slate-800/80 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700 rounded-lg px-4 py-2.5 cursor-not-allowed text-sm"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">
            ...
            <div className="flex-1 flex justify-center items-start">
              {user?.profilePic ? (
                <img
                  src={user?.profilePic}
                  alt="Profile"
                  className="rounded-2xl ring-4 ring-slate-100 dark:ring-slate-800 shadow-md max-w-xs w-full object-cover"
                />
              ) : (
