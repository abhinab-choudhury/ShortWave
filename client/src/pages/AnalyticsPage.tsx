...
import { CartesianGrid, Line, LineChart, XAxis, AreaChart, Area, BarChart, Bar } from "recharts"
    ...
    <div className="min-h-screen w-[100%] border border-neutral-200 dark:border-gray-800 bg-gray-50 dark:bg-inherit overflow-y-scroll scrollbar-slim">
      <div className="p-4 md:p-8 max-w-7xl mx-auto">
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          <ChartCard title="Revenue Growth" description="Monthly revenue trends" />
          <ChartCard title="User Engagement" description="Daily active users" />
          <ChartCard title="Conversion Rate" description="Sales conversion metrics" />
        </div>
